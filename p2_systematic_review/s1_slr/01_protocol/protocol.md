...
> **Status note (2026-05-10): historical/amended protocol text.** This file is retained as SLR protocol provenance. Later amendments, Phase 2 freeze records, and the clean-submission truth map control current repository claims. In particular, the interview/cross-method mixed-methods plan below was design-stage context and is not an executed component in this clean submission repository.
