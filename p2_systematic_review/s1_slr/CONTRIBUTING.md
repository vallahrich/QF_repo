...
Production run used `gpt-5-mini` via Azure OpenAI Responses API. The raw prompt log is archived externally as `p2_systematic_review/s1_slr/03_screening/llm_screening_prompt_log.jsonl`.
...
- The LLM prompt log is kept in the external source archive for deep audit.
