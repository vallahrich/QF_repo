...
**Calibration**: Cohen’s κ = 0.849 (threshold ≥ 0.70). See [calibration_log.md](03_screening/calibration_log.md).
...
All figures are in [`04_figures/`](04_figures/) and can be regenerated via `python generate_figures.py`:
...
- **Screening audit trail** — AI decisions, discrepancy review, calibration log, with raw prompt logs in the external source archive
...
Raw prompt log: `p2_systematic_review/s1_slr/03_screening/llm_screening_prompt_log.jsonl` in the external source archive.
