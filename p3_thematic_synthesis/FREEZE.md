...
- **L3 / R1 timing.** Both layers were executed **in-freeze** before B1/B2 theme generation:
  - **L3 full coverage** (654/654 papers, gpt-5.4-mini @ temp=0.0, prompt `l3_adversarial_v3.txt`) aggregated 2026-04-22T18:58Z to [`s4_thematic_coding/L3_SUMMARY.md`](s4_thematic_coding/L3_SUMMARY.md) and [`s4_thematic_coding/output/l3_summary.json`](s4_thematic_coding/output/l3_summary.json). The earlier 17:00 sample (108/654 = 16.5%, gpt-5.1 prompt v2) is retained under `papers_l3_v2_gpt51_archive/` as a same-prompt-different-model methodological comparator.
  - **R1 stratified review** (153/1,291 = 11.85%; per-silo 10.0–18.6%) executed across **2026-04-23 → 2026-04-25** in three working windows per day (+02:00). Per-silo `_disposition.json` and `r1_review_summary.json` aggregate written 2026-04-25T23:30 → 2026-04-26T00:30 +02:00. Verdict distribution: approved 69 / approved_with_caveat 81 / requires_revision 2 / flag_for_pull 1.
  - **B1/B2/c2 theme generation** ran 2026-04-26 morning UTC, after the R1 dispositions and before the 2026-05-02 freeze.
  - The earlier 2026-04-22T17:30 +02:00 free-text spot-check (~15 papers, [`docs/AUDIT_LOG.md`](docs/AUDIT_LOG.md)) is documented as a sanity check before L3 full coverage, not as the R1 evidence base.
