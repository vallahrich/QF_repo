...
> **Status note (2026-05-10): generated 2026-04-22 shortlist artifact.** Retained as provenance for the theme→literature crosswalk selection; not the current authority. Current truth: [../FREEZE.md](../FREEZE.md) and [../../docs/PROJECT_STATE.yaml](../../docs/PROJECT_STATE.yaml).

Generated: 2026-04-22T21:14:36.611979+00:00

Source: B2 analytical themes × C2 v2 grounding verdicts.
Rule: 2 grounded auto-included; top-10 partial by (supporting_paper_count, grounded_in_count); silo-balance backfill ensures every silo has at least one representative.
Unsupported themes are NOT crosswalked; they go through disposition instead.

## Global counts (v2)

- Total analytical themes: 45
- Grounded: 2
...
|---|------|----------|:-------:|:----:|:------:|:---:|:-------:|-------------|
| 1 | TE | AT-TE-001 | 🟢 grounded | high | 7 | 3 | 2 | The hybridization imperative: quantum as component, not system |
| 2 | SMC | AT-SMC-002 | 🟢 grounded | high | 16 | 2 | 1 | Distribution loading transforms quantum advantage into a hardware-software co-design probl… |
| 3 | RM | AT-RM-001 | 🟡 partially_grounded | high | 42 | 4 | 2 | The quadratic speedup mirage: theoretical advantage systematically eroded across every imp… |
| 4 | FD | AT-FD-005 | 🟡 partially_grounded | medium | 30 | 3 | 2 | Speculative momentum: prospective quantum fraud narratives outpace and misrepresent the em… |
| 5 | FD | AT-FD-001 | 🟡 partially_grounded | medium | 30 | 2 | 2 | Premature methodological convergence on kernel classifiers constrains the search space for… |
| 6 | SMC | AT-SMC-006 | 🟡 partially_grounded | medium | 29 | 5 | 1 | Methodological proliferation signals exploratory-phase maturity without paradigm convergen… |
| 7 | FD | AT-FD-002 | 🟡 partially_grounded | medium | 26 | 3 | 2 | Cascading NISQ constraints create a compounding validity gap that inflates reported quantu… |
| 8 | SMC | AT-SMC-001 | 🟡 partially_grounded | medium | 24 | 4 | 1 | Oracle-complexity advantage collapses under end-to-end cost accounting |
| 9 | SMC | AT-SMC-007 | 🟡 partially_grounded | medium | 24 | 3 | 1 | Finite-register discretization imposes a precision ceiling that redefines advantage thresh… |
| 10 | FD | AT-FD-003 | 🟡 partially_grounded | medium | 23 | 2 | 1 | Imbalance-driven methodological heterogeneity renders quantum-classical performance compar… |
| 11 | SMC | AT-SMC-004 | 🟡 partially_grounded | medium | 21 | 3 | 1 | NISQ and fault-tolerant paradigms offer irreconcilable advantage pathways |
| 12 | SMC | AT-SMC-003 | 🟡 partially_grounded | medium | 19 | 3 | 1 | Computational cost structure of financial risk drives rational quantum target selection |
| 13 | CL | AT-CL-002 | 🟡 partially_grounded | medium | 15 | 2 | 2 | Classical scaffolding as structural necessity rather than transitional convenience |
| 14 | DP | AT-DP-002 | 🟡 partially_grounded | medium | 16 | 2 | 1 | State preparation as a proxy war for quantum pricing viability |
| 15 | PO | AT-PO-001 | 🟡 partially_grounded | medium | 16 | 2 | 2 | The QUBO formulation funnel imposes a binary bottleneck on quantum portfolio expressivenes… |
| 16 | QML | AT-QML-001 | 🟡 partially_grounded | medium | 12 | 3 | 2 | The NISQ pragmatism trap: hybrid design as both enabler and architectural ceiling |

## Grounded themes (auto-included)

### AT-TE-001 (TE) 🟢
**Label**: The hybridization imperative: quantum as component, not system

**Interpretation**: The convergence on hybrid quantum-classical architectures across trading applications is not merely a pragmatic NISQ-era concession but reveals a structural insight: quantum computing's value in trading lies in enhancing specific computational bottlenecks within classical pipelines rather than replacing end-to-end systems. Quantum circuits consistently serve as pluggable modules for feature generation, policy optimization, or combinatorial subroutines, while classical infrastructure handles data ingestion, risk management, and execution. The persistent competitiveness of classical baselines further indicates that quantum contributions must demonstrably exceed the overhead of integration to justify hybrid complexity.

### AT-SMC-002 (SMC) 🟢
**Label**: Distribution loading transforms quantum advantage into a hardware-software co-design problem
...
### AT-RM-001 (RM) 🟡  papers=42 DTs=4
**Label**: The quadratic speedup mirage: theoretical advantage systematically eroded across every implementation layer

**Interpretation**: The most-cited promise of quantum risk management — quadratic speedup via quantum amplitude estimation — is systematically undermined at every implementation layer. Distribution loading costs can exceed the estimation savings, NISQ noise degrades outputs to unusable levels on even modest portfolios, and constant-factor overheads delay crossover to impractical problem sizes. This creates a field-level tension where theoretical query-complexity results continue to motivate research investment while empirical results repeatedly fail to validate operational advantage, suggesting the community is optimizing for a benchmark (oracle query count) that poorly predicts real-world performance.

### AT-FD-005 (FD) 🟡  papers=30 DTs=3
**Label**: Speculative momentum: prospective quantum fraud narratives outpace and misrepresent the empirical evidence base
...
- **AT-TE-003** (TE): Compounding deployment barriers from data encoding to execution latency
- **AT-TE-004** (TE): Regime-conditional quantum utility as niche complement rather than paradigm shift
- **AT-CL-001** (CL): Convergence to classical parity despite proliferating quantum circuit designs for credit scoring
- **AT-FD-004** (FD): Hybrid architectures as pragmatic accommodation: quantum components occupy rather than earn their pipeline niche
- **AT-DP-004** (DP): Benchmarking monoculture conceals the complexity cliff between validation and deployment
- **AT-DP-005** (DP): The hardware-theory gap defines a decade-scale timeline for pricing advantage
- **AT-RM-002** (RM): Hybrid architecture as pragmatic adaptation to hardware inadequacy rather than principled design
- **AT-RM-003** (RM): Quantum machine learning finds niches in data-scarce risk regimes rather than computational frontiers
- **AT-RM-006** (RM): The credit risk maturity paradox: deepest theoretical development coupled with weakest empirical validation
- **AT-SMC-005** (SMC): Classical Monte Carlo’s parallel scalability silently raises the quantum crossover threshold
- **AT-PO-005** (PO): Problem-space expansion toward financial realism proceeds without demonstrated quantum payoff