# `canonical/outputs/` — Canonical experiment outputs

Materialised outputs from canonical P4 experiment runs: manuscript artifacts,
alternative-phase explorations, and scout runs. Rendered figures are not stored
here because the final figure files live in the thesis and appendix; P4 keeps
the source CSVs under `manuscript_artifacts/`.
