"""SD4 — Pricing multi-asset derivatives by variational quantum algorithms.
...
@register(
    ...
    description="SD4 — generic variational ansatz stretch (Pricing multi-asset derivatives by variational quantum algorithms)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SD4_full")
