"""SD8 — Efficient Hamiltonian Simulation for Solving Option Price Dynamics.
...
@register(
    ...
    description="SD8 — generic variational ansatz stretch (Efficient Hamiltonian Simulation for Solving Option Price Dynamics)",
)
