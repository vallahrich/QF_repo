"""SD13 — Quantum-inspired variational algorithms for partial differential equations: Appl.
...
@register(
    ...
    description="SD13 — generic variational ansatz stretch (Quantum-inspired variational algorithms for partial differential equations: Appl)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SD13_full")
