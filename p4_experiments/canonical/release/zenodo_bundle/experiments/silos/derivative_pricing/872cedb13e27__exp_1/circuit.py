"""SD9 — Noise-Robust Quantum Generative Models for Distribution Learning and Efficient Data Loading.
...
@register(
    ...
    description="SD9 — generic variational ansatz stretch (Noise-Robust Quantum Generative Models for Distribution Learning and Efficient Data Loading)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SD9_full")
