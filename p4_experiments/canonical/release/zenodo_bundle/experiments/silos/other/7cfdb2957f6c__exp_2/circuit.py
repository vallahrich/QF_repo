"""SX5 — Demonstration of quantum linear equation solver on the IBM qiskit platform.
...
@register(
    ...
    description="SX5 — generic variational ansatz stretch (Demonstration of quantum linear equation solver on the IBM qiskit platform)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SX5_full")
