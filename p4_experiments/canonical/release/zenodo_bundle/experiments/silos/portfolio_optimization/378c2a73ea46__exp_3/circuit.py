"""SP9 — Impacting Financial Predictions & Security through Quantum Support Vector Machin.
...
@register(
    ...
    description="SP9 — generic variational ansatz stretch (Impacting Financial Predictions & Security through Quantum Support Vector Machin)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SP9_full")
