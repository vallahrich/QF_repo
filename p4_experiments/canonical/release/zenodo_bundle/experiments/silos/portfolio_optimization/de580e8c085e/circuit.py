"""SP7 — Qudit-based scalable quantum algorithm for solving the integer programming probl.
...
@register(
    ...
    description="SP7 — generic variational ansatz stretch (Qudit-based scalable quantum algorithm for solving the integer programming probl)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SP7_full")
