"""SQ5 — Improved Financial Forecasting via Quantum Machine Learning.
...
@register(
    ...
    description="SQ5 — generic variational ansatz stretch (Improved Financial Forecasting via Quantum Machine Learning)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ5_full")
