"""SQ15 — Contextual Quantum Neural Networks for Stock Price Prediction.
...
@register(
    ...
    description="SQ15 — generic variational ansatz stretch (Contextual Quantum Neural Networks for Stock Price Prediction)",
)
