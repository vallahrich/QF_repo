"""SQ6 — Entanglement-Based Machine Learning on a Quantum Computer.
...
@register(
    ...
    description="SQ6 — generic variational ansatz stretch (Entanglement-Based Machine Learning on a Quantum Computer)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ6_full")
