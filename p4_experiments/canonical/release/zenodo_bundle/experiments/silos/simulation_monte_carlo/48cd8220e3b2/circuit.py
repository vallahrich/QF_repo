"""SM8 — Entanglement scaling in matrix product state representation of smooth functions .
...
@register(
    ...
    description="SM8 — generic variational ansatz stretch (Entanglement scaling in matrix product state representation of smooth functions )",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SM8_full")
