"""SD1 — Efficient Hamiltonian Simulation for Solving Option Price Dynamics.
...
@register(
    ...
    description="SD1 — generic variational ansatz stretch (Efficient Hamiltonian Simulation for Solving Option Price Dynamics)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SD1_full")
