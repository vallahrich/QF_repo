"""SD9 — Quantum-inspired variational algorithms for partial differential equations: Appl.
...
@register(
    ...
    description="SD9 — generic variational ansatz stretch (Quantum-inspired variational algorithms for partial differential equations: Appl)",
)
