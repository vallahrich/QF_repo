"""SD11 — Explicit block-encoding for partial differential equation-constrained optimizati.
...
@register(
    ...
    description="SD11 — generic variational ansatz stretch (Explicit block-encoding for partial differential equation-constrained optimizati)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SD11_full")
