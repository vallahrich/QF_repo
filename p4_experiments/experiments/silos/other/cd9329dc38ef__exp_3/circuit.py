"""SX8 — Quantum Attacks on Bitcoin, and How to Protect Against Them.
...
@register(
    ...
    description="SX8 — generic variational ansatz stretch (Quantum Attacks on Bitcoin, and How to Protect Against Them)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SX8_full")
