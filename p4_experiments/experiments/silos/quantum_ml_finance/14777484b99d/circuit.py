"""SQ7 — Quantum Algorithm for Unsupervised Anomaly Detection.
...
@register(
    ...
    description="SQ7 — generic variational ansatz stretch (Quantum Algorithm for Unsupervised Anomaly Detection)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ7_full")
