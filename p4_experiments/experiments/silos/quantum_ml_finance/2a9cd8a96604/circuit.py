"""SQ9 — Quantum support vector data description for anomaly detection.
...
@register(
    ...
    description="SQ9 — generic variational ansatz stretch (Quantum support vector data description for anomaly detection)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ9_full")
