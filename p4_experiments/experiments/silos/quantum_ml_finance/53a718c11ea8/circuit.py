"""SQ10 — Quantum machine learning for quantum anomaly detection.
...
@register(
    ...
    description="SQ10 — generic variational ansatz stretch (Quantum machine learning for quantum anomaly detection)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ10_full")
