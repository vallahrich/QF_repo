"""SQ12 — Quantum Machine Learning: Harnessing Quantum Algorithms for Supervised and Unsupervised Learning.
...
@register(
    ...
    description="SQ12 — generic variational ansatz stretch (Quantum Machine Learning: Harnessing Quantum Algorithms for Supervised and Unsupervised Learning)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ12_full")
