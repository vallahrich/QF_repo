"""SQ12 — Quantum State Preparation by Improved MPS Method.
...
@register(
    ...
    description="SQ12 — generic variational ansatz stretch (Quantum State Preparation by Improved MPS Method)",
)
