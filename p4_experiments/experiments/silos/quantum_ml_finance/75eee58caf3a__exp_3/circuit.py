"""SQ14 — Contextual Quantum Neural Networks for Stock Price Prediction.
...
@register(
    ...
    description="SQ14 — generic variational ansatz stretch (Contextual Quantum Neural Networks for Stock Price Prediction)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ14_full")
