"""SQ27 — Generative learning with Qopula circuits.
...
@register(
    ...
    description="SQ27 — generic variational ansatz stretch (Generative learning with Qopula circuits)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SQ27_full")
