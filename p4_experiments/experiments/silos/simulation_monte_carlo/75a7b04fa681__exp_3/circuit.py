"""SM12 — Encoding of Probability Distributions for Quantum Monte Carlo Using Tensor Netwo.
...
@register(
    ...
    description="SM12 — generic variational ansatz stretch (Encoding of Probability Distributions for Quantum Monte Carlo Using Tensor Netwo)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SM12_full")
