"""SM15 — A quantum spectral method for simulating stochastic processes, with applications.
...
@register(
    ...
    description="SM15 — generic variational ansatz stretch (A quantum spectral method for simulating stochastic processes, with applications)",
)
...
def _full_oracle(instance: Dict[str, Any], bare: QuantumCircuit) -> QuantumCircuit:
    ...
    n = int(p["n_qubits"])
    a = _ansatz_only(p)
    qc = QuantumCircuit(n, n, name="SM15_full")
