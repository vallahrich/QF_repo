"""SM5 — Quantum algorithm for solving McKean-Vlasov stochastic differential equations.
...
@register(
    ...
    description="SM5 — QAE template proxy (Quantum algorithm for solving McKean-Vlasov stochastic differential equations)",
)
def build_bare(instance: Dict[str, Any]) -> QuantumCircuit:
    p = instance["parameters"]
    sp = _state_prep(p)
    qc = QuantumCircuit(sp.num_qubits, sp.num_qubits, name="SM5_bare")
